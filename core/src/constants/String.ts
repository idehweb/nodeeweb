...
export const CRUD_DEFAULT_REQ_KEY = 'crud';
export const ACTIVITY_TARGET_BEFORE_REQ_KEY = 'target_before';
export const ACTIVITY_TARGET_AFTER_REQ_KEY = 'target_after';
