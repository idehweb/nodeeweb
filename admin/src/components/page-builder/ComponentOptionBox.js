...
const ComponentOptionBox = (props) => {
  ...
  const [theComponentForSetting, setTheComponentForSetting] =
    useState(componentForSetting);
  useEffect(() => {
  ...
  return (
    <CustomModal
      ...
      open={open}
      className={'width50vw  kiuytgfhjuyt modal'}
      ...
      <div className={'npb-componentForSetting-settings'}>
        ...
        {tab === 'delete' && (
          <Card small className={'p-3 npb-d-flex'}>
...
export default ComponentOptionBox;
