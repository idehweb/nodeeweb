...
const Form = ({ children, ...rest }) => {
  ...
  return (
    <SimpleForm {...rest} onSubmit={(v) => saveForm(v)}>
      {children}
      <TextInput
        source={'_id'}
        label={translate('_id')}
      ...
      <span style={{ marginTop: '15px' }}>قیت بر دسته بندی</span>
      <RadioButtonGroupInput
        label={translate('resources.category.priceType')}
        source="priceType"
        choices={choices}
      />
