    ...
    <Edit actions={<PostEditActions />} {...props}>
      <SimpleForm>
        <TextInput
          ...
          label={translate('resources.campaign.title')}
        ...
        <TextInput
          source="slug"
          label={translate('resources.campaign.slug')}
        ...
        <TextInput
          multiline
          source="message"
          label={translate('resources.campaign.message')}
          fullWidth
        />
        <div className={'ltr'}>{translate('resources.messages.help')}</div>
        ...
        <ReferenceInput
          ...
          <SelectInput
            fullWidth
            label={translate('resources.campaign.customerGroup')}
            optionText="name.fa"
          />
        </ReferenceInput>
        ...
        <TextInput
          source="phoneNumber"
          label={translate('resources.campaign.phoneNumber')}
          fullWidth
        />
        <TextInput
          source="limit"
          label={translate('resources.campaign.limit')}
          fullWidth
        />
        <TextInput
          source="offset"
          label={translate('resources.campaign.offset')}
          fullWidth
        />
        <TextInput
          className={'ltr'}
          source="link"
          label={translate('resources.campaign.link')}
          fullWidth
        />
      </SimpleForm>
    </Edit>
