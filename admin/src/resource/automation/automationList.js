    ...
    <List {...props} filters={<PostFilter />} pagination={<PostPagination />}>
      <Datagrid optimized>
        <TextField
          ...
          label={translate('resources.automation.title')}
        />
        <TextField
          source={'crontab_expr'}
          fullWidth
          label={translate('resources.automation.crontab_expr')}
        />
        <TextField
          source={'query_pipe'}
          fullWidth
          label={translate('resources.automation.query_pipe')}
        />
        <TextField
          source={'aggregation_pipe'}
          fullWidth
          label={translate('resources.automation.aggregation_pipe')}
        />
        <TextField
          source={'action'}
          fullWidth
          label={translate('resources.automation.action')}
        />
