  ...
  return (
    <SimpleForm {...props} onSubmit={save}>
      ...
      <TextInput
        ...
        fullWidth
        source="sms_welcome"
        label={translate('resources.settings.welcome')}
      />
      <TextInput
        multiline
        fullWidth
        source="sms_register"
        label={translate('resources.settings.register')}
      />
      <TextInput
        multiline
        fullWidth
        source="sms_submitOrderNotPaying"
        label={translate('resources.settings.submitOrderNotPaying')}
      />
      <TextInput
        multiline
        fullWidth
        source="sms_submitOrderSuccessPaying"
        label={translate('resources.settings.submitOrderSuccessPaying')}
      />
      {/*<TextInput multiline fullWidth source="sms_status_link" label={translate('product.description')} />*/}
      <TextInput
        multiline
        fullWidth
        source="sms_onSendProduct"
        label={translate('resources.settings.onSendProduct')}
      />
      <TextInput
        multiline
        fullWidth
        source="sms_onGetProductByCustomer"
        label={translate('resources.settings.onGetProductByCustomer')}
      />
      <TextInput
        multiline
        fullWidth
        source="sms_submitReview"
        label={translate('resources.settings.submitReview')}
      />
      <TextInput
        multiline
        fullWidth
        source="sms_onCancel"
        label={translate('resources.settings.onCancel')}
      />
      <TextInput
        multiline
        fullWidth
        source="factore_shop_name"
        label={translate('resources.settings.shop_name')}
      />
      <TextInput
        multiline
        fullWidth
        source="factore_shop_site_address"
        label={translate('resources.settings.shop_site_address')}
      />
      <TextInput
        multiline
        fullWidth
        source="factore_shop_address"
        label={translate('resources.settings.shop_address')}
      />
      <TextInput
        multiline
        fullWidth
        source="factore_shop_phoneNumber"
        label={translate('resources.settings.shop_phoneNumber')}
      />
      <TextInput
        multiline
        fullWidth
        source="factore_shop_faxNumber"
        label={translate('resources.settings.shop_faxNumber')}
      />
      <TextInput
        multiline
        fullWidth
        source="factore_shop_postalCode"
        label={translate('resources.settings.shop_postalCode')}
      />
      <TextInput
        multiline
        fullWidth
        source="factore_shop_submitCode"
        label={translate('resources.settings.shop_submitCode')}
      />
      <TextInput
        multiline
        fullWidth
        source="factore_shop_internationalCode"
        label={translate('resources.settings.shop_internationalCode')}
      />
      {/*defaultSmsGateway*/}
      <ReferenceInput
