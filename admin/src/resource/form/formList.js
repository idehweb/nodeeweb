...
const PostFilter = (props) => {
  ...
  return (
    <Filter {...props}>
      <SearchInput
        source="Search"
        placeholder={translate('resources.form.search')}
        alwaysOn
      />
      <SearchInput
        source="category"
        placeholder={translate('resources.form.category')}
        alwaysOn
      />
  ...
  return (
    <List
      ...
      <Datagrid optimized>
        ...
        <FunctionField
          label={translate('resources.form.date')}
          render={(record) => (
            <div className="theDate">
              <div>
                {translate('resources.form.createdAt') +
                  ': ' +
                  `${dateFormat(record.createdAt)}`}
              </div>
              <div>
                {translate('resources.form.updatedAt') +
                  ': ' +
              ...
              {record.view && (
                <div>
                  {translate('resources.form.viewsCount') +
                    ': ' +
                    `${record.view}`}
                </div>
              )}
        ...
        />
        <FunctionField
          label={translate('resources.form.actions')}
          render={(record) => (
            <div>
              <div>
