              ...
              <div className={'allCatse mt-4'}>
                {firstCategory &&
                  ...
                  firstCategory.name[lan] && [
                    <Link to={'/'} className={'gfdcvgfd'} key={0}>
                      <span className={'categories ml-1 mt-2'}>
                        {t('home')}
                      </span>
                    </Link>,
                    <Link to={'/'} className={'gfdcvgfd'} key={1}>
          ...
          <Row>
            ...
            <Col lg={3} md={3} sm={6} xs={6} className={'mb-3'}>
              <div>
                ...
                <div className={'pro-icons-title'}>پرداخت حضوری و غیرحضوری</div>
              </div>
            </Col>
            <Col lg={3} md={3} sm={6} xs={6} className={'mb-3'}>
              {/* <div className={"pro-icons-wrapper"}> */}
              <div>
                ...
                <div className={'pro-icons-title'}>امکان ارسال فوری</div>
              </div>
            </Col>
            <Col lg={3} md={3} sm={6} xs={6} className={'mb-3'}>
              {/* <div className={"pro-icons-wrapper"}> */}
              <div>
                ...
                <div className={'pro-icons-title'}>پرداخت امن</div>
              </div>
            </Col>
          </Row>
        </Col>
