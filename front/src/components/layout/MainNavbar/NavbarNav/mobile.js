...
export default () => {
  ...
  return (
    <Nav navbar className={'flex-row stfwrap' + searchform}>
      <div className={'search-button'}>
        <SearchIcon className={'black'} />
      </div>
      <div
        className={
          'd-table m-auto oiuytrt tm-ksa-logo-parent2 nonestf' + searchform
        }>
        <Link to="/">
          {logoImg && (
            <img style={{ maxWidth: 58 }} src={logoImg} alt="mobile logo" />
          )}
        </Link>
      </div>
      {/*<MainCats/>*/}
