      ...
      <Nav className="nav--no-borders flex-column sizeless sideattributes p-2">
        <NavItem>
          <Col sm={12} lg={12} className={'p-1'}>
            <Link
              className={'filter-en ' + isEnable('g1')}
              to={
                '?attr=guarantee&value=guarantee-of-authenticity-and-physical-health'
              }
              onClick={() => {
          ...
          <Col sm={12} lg={12} className={'p-1'}>
            <Link
              className={'filter-en ' + isEnable('g2')}
              to={'?attr=guarantee&value=green-guarantee'}
              onClick={() => {
          ...
          <Col sm={12} lg={12} className={'p-1'}>
            <Link
              className={'filter-en ' + isEnable('g3')}
              to={'?attr=guarantee&value=gold-guarantee'}
              onClick={() => {
