...
function CreateForm(props) {
  ...
  const TheField = (field) => {
    ...
    if (type === 'document') {
      return (
        <FieldUploadDocument formID={formFiledsDetail._id} field={field} />
      );
    }
    // if (type === "text") {
                ...
                <input
                  ...
                  className={
                    meta.error && meta.touched
                      ? 'mb-2 form-control  border-danger'
                      : 'mb-2 form-control '
                  }
                  {...input}
                  type="text"
    ...
    if (type === 'text') {
      return (
        <span name={name} className="mb-2" style={style}>
          {value}
        </span>
      );
    }
            ...
            {(props) => {
              return (
                <div className={'max-width100'}>
                  ...
                  {props.input.value && (
                    <img src={combineUrl(MainUrl, props.input.value)} />
                  )}
                </div>
              );
            }}
            ...
            <form onSubmit={handleSubmit}>
              <Container>
                <Row>
                  ...
                  {formFiledsDetail.hasOwnProperty('showSubmitButton') ===
                    false && (
                    <div className="buttons">
                      <Button type="submit">{t('Submit')}</Button>
                    </div>
