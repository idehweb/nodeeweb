                                    ...
                                    <Grid container spacing={2} columns={12}>
                                        ...
                                        <Grid item xs={6}>
                                            <section style={{textAlign:'right'}}>
                                                <span style={{width:'100%',display:'inline-block'}}>پشتیبانی سایت آروند شاپ</span>
                                                <span style={{width:'100%',display:'inline-block',fontSize:'12px'}}>پاسخگوی سوالات شما هستیم</span>
                                            </section>
                                        </Grid>
                                        <Grid item xs={2}>
