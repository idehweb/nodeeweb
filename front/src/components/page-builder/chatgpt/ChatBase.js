        ...
        <header
          ...
          <div
            ...
            <span
              ...
              data-original-title="دیجیتال مارکتینگ آروند">
              <img
                src="https://cdn.goftino.com/static/assets/img/profile.png"
                alt="avatar"
                width="40"
                height="40"
              />
            ...
            <span
              ...
              rel="tooltip"
              data-placement="auto left"
              data-original-title="ادمین 1">
              <img
                src="https://cdn.goftino.com/profile/63f9cd63f0d5b21b92d7e53ew12a.jpg"
                alt="avatar"
                width="40"
                height="40"
              />
            ...
            <span
              ...
              rel="tooltip"
              data-placement="auto left"
              data-original-title="علیرضا رضوان">
              <img
                src="https://cdn.goftino.com/static/assets/img/profile.png"
                alt="avatar"
                width="40"
    ...
    <React.Fragment>
      {data && data.type === 'client' ? (
        <div className="mine messages">
          <div className="message last">{data && data.text}</div>
        </div>
      ) : (
        data &&
        data.type === 'support' && (
          <div className="yours messages">
            <div
              className={
                data.username === 'ERR_NETWORK'
                  ? 'message last borderDanger'
                  : 'message last '
              }>
              {data && data.text}
            </div>
  ...
  const handlerCallBackMessage = async (value) => {
    ...
    if (localStorage.getItem('onlineSupport')) {
      ...
      if (value) {
        ...
        Block.dots('.chat');
        await axios
          .post(ApiUrl + '/gateway/chatgpt/chat', messageObjClient, { headers })
          .then((res) => {
            if (res) {
              const { data } = res;
