...
const Packing = (props) => {
  ...
  const [items, setItems] = useState([
    { item: '', description: '', qty: '', net: '', gross: '', total: '' },
  ]);
  ...
  const handleTheClick = (v) => {
    ...
    if (v && v.items)
      v.items.forEach((itemv) => {
        totalnet += parseInt(itemv.net);
        totalgross += parseInt(itemv.gross);
                  ...
                  <form onSubmit={handleSubmit}>
                    <Container>
                      <Row>
                        ...
                        <Col lg={12} sm={12} md={12} className={'MGD '}>
                                  ...
                                  <div className={'row'}>
                                    <Col
                                      ...
                                      <label
                                        ...
                                        {'DESCRIPTION AND QUALITIES OF GOODS'}
                                      </label>
                                      <Field
            ...
            <div id={'theprint'} ref={divRef} className={dis}>
              ...
              <table
                ...
                <tr style={trStyle}>
                  ...
                  <td colSpan={'1'}>
                    <div>
                      <span>TRANSPORT BY:</span>
                      <span>{transportby}</span>
                    </div>
                  </td>
                </tr>
                ...
                <tr
                  style={{ ...trStyle, textAlign: 'center' }}
                  className={'text-c'}>
                  <td
                    style={{ borderWidth: '1px' }}
                    colSpan={'1'}
...
export default withTranslation()(Packing);
