...
const Packing = (props) => {
  ...
  const [items, setItems] = useState([{item: '', description: '', qty: '', net: '', gross: '', total: ''}]);
  ...
  const handleTheClick = (v) => {
    ...
    setAns({...ans, ...v,totalnet:totalnet,totalgross:totalgross,totalCount:totalCount})
    // setDis('d-block')
    setTimeout(() => {
      handleClick();
  ...
  const addMore = () => {
    items.push({item: '', description: '', qty: '', net: '', gross: '', total: ''})
    console.log('addMore...')
  ...
  let {s0, s1, s2, s3, totalnet,transportby,hscode,totalCount, totalgross, exporter, total, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, s20} = ans
                          ...
                          {items && items.map((item, i) => {
                            return <div className={'row'}>
                              ...
                              <Col
                                lg={4} sm={12} md={12}
                                className={'MGD '}>
                                <label htmlFor={'items[' + i + ']["qty"]'}>{'QTY'}</label>
                                <Field
                                  name={'items[' + i + ']["qty"]'}
                                  component="input"
                                  placeholder={'تعداد'}
          ...
          <div id={"theprint"} ref={divRef} className={dis}>
            ...
            <table className={'table'}
              ...
              <tr style={trStyle} className={'text-c'}>
                ...
                <td style={{borderWidth: '1px'}} colSpan={'2'} rowSpan={'1'}>
                  <div>WEIGHT</div>
                  <div>KG</div>
              ...
              <tr style={{...trStyle, textAlign: 'center'}} className={'text-c'}>
