              ...
              {thecalc && (
                <Form
                  ...
                  initialValues={{
                    A: 0,
                    B:
                      tracks && tracks[1] && tracks[1].price
                        ? returnNormalPrice(tracks[1].price)
                        : 0,
                    D: 0,
                    E: 0,
                    I: 0,
              ...
              <Form
                ...
                render={({
                  ...
                  <form onSubmit={handleSubmit}>
                    <Container>
                      <Row>
                        <Col className={'MGD '} lg={6} sm={12} md={12}>
                        ...
                        <Col lg={6} sm={12} md={12} className={'MGD '}>
                      ...
                      <Row>
                        <div className="buttons">
                          <Button type="submit">{'پرینت'}</Button>
                        </div>
                      </Row>
                    </Container>
                  </form>
            ...
            <div id={'theprint'} ref={divRef} className={dis}>
              <table
                ...
                <tr style={trStyle}>
                  ...
                  <td
                    rowSpan={'7'}
                    style={{ borderWidth: '1px', verticalAlign: 'baseline' }}
                    colSpan={'4'}>
                ...
                <tr style={trStyle}>
                  <td rowSpan={'4'}>۲۹.بسته ها و شرح کالا</td>
              ...
              <table
                ...
                <tr style={trStyle}>
                  <td
                    style={{ borderWidth: '1px', width: '33%' }}
                    colSpan={'1'}>
                  ...
                  <td style={{ borderWidth: '1px' }} colSpan={'1'}>
                    <div style={{ textAlign: 'justify', direction: 'rtl' }}>
                      این اظهار نامه را با رعایت کلیه قوانین و مقررات موبوطه و
                      با قبول کلیه تکالیف و مسئولیت های موضوع تبصره ۲ ماده ۲۹
                      قانون ق.ا.گ و ماده ۶۴ آ.ا.ق.ا.گ تنظیم نمودم. تصریح مینمایم
                      کلیه اسناد ضمیمه اظهار نامه با اسناد بارگذاری شده در
                      سامانه جامع امور گمرکی(پنجره واحد تجارت فرامرزی) از هر جهت
                      مطابقت دارد نام و امضای اظهار کننده/نماینده:
                    </div>
                  </td>
                </tr>
              </table>
            ...
            <div className={'response-flex'}>
              {nerkh && (
                <div>
                  <span>نرخ ارز:</span>
                  <span>
                    {nerkh.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                  </span>
                </div>
              )}
              {c && (
